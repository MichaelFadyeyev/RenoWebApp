...
const ProcessStatuses = () => {
    ...
    const { processStatuses } = useContext(Context);
    const { setProcessStatuses } = useContext(Context);
    ...
    const addItem = async (name, details) => {
        try {
            fetch(AppRouts.adminProcessStatuses + "&action=add", {
                method: "POST",
                headers: {
    ...
    const updateItem = async (id, name, details) => {
        try {
            fetch(AppRouts.adminProcessStatuses + "&action=update", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const deleteItem = async (id) => {
        try {
            fetch(AppRouts.adminProcessStatuses + "&action=delete", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
